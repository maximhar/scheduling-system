    ...
    public class Schedule
    {
        ...
        public TimeSpan GetStartTime(int aDay, StudentGroup aGroup)
        {
            if (aDay >= startTimes.Length || aDay < 0)
                throw new ArgumentOutOfRangeException("aDay", "Day should be between 0 and 7");
        ...
        {
            if (aDay < 0 || aDay >= 7) throw new ArgumentOutOfRangeException("aDay", "Day should be between 0 and 7");
